...
- Adjustable nodes, racks, replication factor, consistency level, and client count
- Per-client Write / Read buttons — requests visibly originate from a specific client
- Rack-aware replica placement, with click-to-kill/revive on both individual nodes and whole racks
